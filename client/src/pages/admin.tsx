...
import { Search, Plus, User, Users, Home } from "lucide-react";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <Breadcrumb className="mb-5">
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbLink href="/admin" className="font-semibold">Admin Overview</BreadcrumbLink>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
            ...
            <Card className="bg-white shadow rounded-lg overflow-hidden mb-8 mt-8">
