  ...
  const createProductMutation = useMutation({
    mutationFn: async (data: typeof formData) => {
      return apiRequest('POST', '/api/products', {
        ...
        partner_id: data.partner_id && data.partner_id !== 'none' ? parseInt(data.partner_id) : null,
        region_id: data.region_id && data.region_id !== 'none' ? parseInt(data.region_id) : null,
        ...
        model_id: data.model_id && data.model_id !== 'none' ? parseInt(data.model_id) : null,
        device_type_id: data.device_type_id && data.device_type_id !== 'none' ? parseInt(data.device_type_id) : null,
      }).then(res => res.json());
    },
    onSuccess: () => {
