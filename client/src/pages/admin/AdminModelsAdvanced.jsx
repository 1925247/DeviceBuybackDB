...
import { Plus, Edit2, Trash2, Save, X, Upload, IndianRupee, ChevronDown, ChevronRight, Search } from 'lucide-react';
    ...
    try {
      ...
      if (response.ok) {
        ...
        setNewModel({
          ...
          description: '', year: new Date().getFullYear(), basePrice: '', image: '',
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage device models with variants and pricing</p>
        </div>
        <button
          ...
          <div key={model.id} className="bg-white rounded-lg shadow border border-gray-200 p-6">
            ...
            {expandedModels[model.id] && (
              <div className="border-t pt-4">
                <div className="flex justify-between items-center mb-4">
                  <h4 className="font-medium text-gray-900">Model Variants</h4>
                  <button
                    onClick={() => setShowAddVariant(model.id)}
                ...
                <div className="space-y-2">
                  {model.variants && model.variants.length > 0 ? (
                    ...
                    <p className="text-gray-500 text-sm py-4 text-center">
                      No variants added yet. Click "Add Variant" to create storage options with different pricing.
                    </p>
                  )}
                </div>
              </div>
      ...
      {filteredModels.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 text-sm mt-2">
            {searchTerm ? 'Try adjusting your search' : 'Start by adding your first model'}
          </p>
        </div>
      )}
    </div>
